...
function setup() {
  ...
  jump = createSprite(width - 100, 215, 30, 30);
...
function draw() {
  ...
  if (mouseIsOver(info)) {
    ...
    text("the gold, silver and bronze coins to boost your coin power packs. if you go to the devil", 10, 85, fill("white"),textSize(17.5));
...
function goldCoin() {
  ...
  if (frameCount % 210 === 0) {
    coin = createSprite(width, 110, 20, 20);
...
function silverCoin() {
  ...
  if (frameCount % 80 === 0) {
    coin2 = createSprite(width, 110, 20, 20);
...
function bronzeCoin() {
  ...
  if (frameCount % 50 === 0) {
    coin3 = createSprite(width, 110, 20, 20);
